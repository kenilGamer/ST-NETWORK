...
function Hero3() {
  ...
  return (
    <div className='w-full  relative py-20 px-20 gap-10 flex flex-col min-h-screen'>
        <h1 className='st text-center aab text-6xl'>Welcome to the shop!</h1>
        
        <div ref={container} className='flex w-full items-center justify-between gap-5 flex-wrap'>
